...
const Footer = ({footer}) => {
    return (
       <>
       <Container>
        <div className="PreFooter row mt-4">
            <div className='col-sm-4 my-2'>
                {repeatIcon}
                 <p> <b>Hassle-free replacement</b> <br/>10-day easy replacement policy on mi.com</p>
               </div>
            <div className='col-sm-4 my-2'>{shieldIcon} <p> <b>100% secure payments</b> <br/> We support Cards, Wallets, EMI and COD</p></div>
            <div className='col-sm-4 my-2'>{mapIcon} <p> <b>Vast service network</b> <br/> 1000 Mi service-centers across 600 cities</p></div>
        </div>

        <div className="PreFooter2 p-2 row">
             <div className='col-sm-3 my-2'> <p>LET'S STAY IN TOUCH</p><span>Get updates on sales specials and more</span></div>
        ...
        <div className="footer-wrapper">
            <Container>
                  <footer className='footer row py-2'>
