...
const NavOptios = ( {miPhones,redmiPhones,tv,laptop,fitnessAndLifeStyle,home,audio,accessories}) => {
   ...
   useEffect(() => {
    if(window.location == "http://localhost:3000/#miphones"){
        return   setMiPhoneToggle(true)
       }
     if(window.location == "http://localhost:3000/#redmiphones"){
        return   setRedmiPhoneToggle(true)
       }
       if(window.location == "http://localhost:3000/#tv"){
        return   setTvToggle(true)
       }
       if(window.location == "http://localhost:3000/#laptops"){
        return   setLaptopToggle(true)
       }
       if(window.location == "http://localhost:3000/#lifestyle"){
        return  setFitnessToggle(true)
       }
       if(window.location == "http://localhost:3000/#home"){
        return  setHomeToggle(true)
       }
       if(window.location == "http://localhost:3000/#audio"){
        return  setAudioToggle(true)
       }
       
       if(window.location == "http://localhost:3000/#accessories"){
